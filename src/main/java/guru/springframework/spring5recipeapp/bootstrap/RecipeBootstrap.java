...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Optional<Category> fastFoogCategoryOptional = categoryRepository.findByDescription("Fast Food");

        if(!fastFoogCategoryOptional.isPresent()) {
            throw new RuntimeException("Expected Category Not Found");
        }
        ...
        Category fastFoodCategory = fastFoogCategoryOptional.get();
